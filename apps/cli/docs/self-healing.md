...
([`src/lib/versions.ts`](../src/lib/installations/versions.ts)) probes the resolved binary via
...
| Piece | Location |
|---|---|
| `ensureAgentRunnable()` — the self-heal engine | [`src/lib/versions.ts`](../src/lib/installations/versions.ts) |
| `resolveLaunchBinary()` — the not-installed probe | [`src/lib/exec.ts`](../src/lib/exec.ts) |
| `verifyInstalledBinaryLaunches()` — the launch probe | [`src/lib/versions.ts`](../src/lib/installations/versions.ts) |
| `isMissingBinarySignature()` — the "broken" classifier | [`src/lib/versions.ts`](../src/lib/installations/versions.ts) |
| `installVersion(..., { clean })` — Layer 1 gate + wipe-then-reinstall | [`src/lib/versions.ts`](../src/lib/installations/versions.ts) |
