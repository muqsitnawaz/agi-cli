...
then swapped by directory rename, so a crash at any point leaves the old store
intact and readable. No plaintext secret value or passphrase is ever written to
