...
// Build a v21-shaped DB (no used_browser/used_computer columns), then let
// db.js's getDB() upgrade it to v22 (#11) on first open. Unlike v17's
// recentDirectoriesTouched migration, this one does NOT wipe scan_ledger —
// usedBrowser/usedComputer are computed from a sessionId-scoped events-log
// read (enrichCachedSessionMeta), not from the transcript ledger, so an
...
describe('schema migration v21 -> v22 (usedBrowser/usedComputer, #11)', () => {
