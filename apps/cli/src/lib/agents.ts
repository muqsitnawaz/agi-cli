...
export const AGENTS: Record<AgentId, AgentConfig> = {
  ...
  kiro: {
    ...
    variableSyntax: '$ARGUMENTS',
    supportsHooks: true,
    capabilities: { hooks: { since: '0.10.0' }, mcp: true, mcpHttp: false, mcpHeaders: false, allowlist: { since: '2.8.0' }, skills: true, commands: true, plugins: false, subagents: false, rules: { file: 'AGENTS.md' }, workflows: false, modes: ['edit'] },
  },
  goose: {
    id: 'goose',
    name: 'Goose',
