...
describe('projectFromCwd', () => {
  it('takes the basename of cwd', () => {
    expect(projectFromCwd('/home/me/src/agents-cli')).toBe('agents-cli');
    expect(projectFromCwd('/repo/foreman/')).toBe('foreman');
  });
...
describe('buildAttachment', () => {
  ...
  it('drops a missing local file (fail-open)', () => {
