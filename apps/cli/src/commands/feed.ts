...
/**
 * Render one activity event: deliberate progress posts (`status.posted`) use the
 * rich multi-line {@link formatProgressUpdate}; hook milestones (PR, commit, …)
 * keep the compact {@link formatActivityLine}.
 */
